...
//Listener class created to generate extent report
import java.io.File;
...
public class Reporting extends TestListenerAdapter
{
	...
	public void onStart(ITestContext testContext) 
	{
		...
		String repName="TestReport-"+timestampString+".html";
	...
	public void onTestFailure(ITestResult tr)
	{
		...
		String screenshotpath=System.getProperty("user.dir")+"\\FrameWork.Screenshots\\"+tr.getName()+".png";
